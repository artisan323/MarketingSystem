...
public class HttpUtil {
    ...
    public static Object checkUserIsExist(MultipartFile file){
        String result="";
        ...
        try {
            ...
            // 服务器的域名
            URL url = new URL("http://129.28.173.126:8088/clientupimg/");
            ...
            sb.append(newLine);
            // 文件参数,photo参数名可以随意修改
            sb.append("Content-Disposition: form-data;email=\"artisan323@163.com\";pass=\"123456\";file=\"" + file.getOriginalFilename()
                    + "\"" + newLine);
