...
<head>
    ...
    <script type="text/javascript">
        ...
        //     var traget=document.getElementById(0);
                                            ...
                                            <div class="form-item input">
                                                ...
                                                <div data-v-cfdfcc88="" class="form-item-wrapper">
                                                    <div data-v-0a785b19="" data-v-cfdfcc88="" class="input-search text-input">
                                                        <div data-v-0a785b19="" class="serach-input byted-input byted-input-md byted-input-suffix"><!---->
                                                            <input type="text" name="slogan" placeholder="请输入" minlength="0" maxlength="Infinity" class="bui-input"> <!----> <!----> <!---->
                                                        </div>
                                ...
                                <form id="upGoods">
                                    <div class="panel image">
                                        ...
                                        <div class="content">
                                            <div class="wrapper">
                                                ...
                                                <div class="upload">
                                                    <input type="button" value="选取文件" class="bui-btn" onclick="getGoodFile()">
                                                    <input style="display: none" type="file"  name="upGoodsImg" id="getG">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel text">
                                        <div class="title">上传位置</div>
                                        <div class="content">
                                            <div class="form-wrapper">
                                                <div class="form-item input">
                                                    <label  class="form-item-label">请选择</label>
                                    ...
                                    <div class="panel text">
                                        ...
                                        <div class="content">
                                            <div class="form-wrapper">
                                                <div class="form-item input">
                                                    <input type="text" name="gdName" placeholder="请输入" minlength="0" maxlength="Infinity" class="bui-input">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content">
                                            <div class="form-wrapper">
                                                <div class="form-item input">
                                                    <input type="text" name="gdPrice" placeholder="请输入" minlength="0" maxlength="Infinity" class="bui-input">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <button data-v-cfdfcc88="" type="button" class="bui-btn-s" onclick="submitGoods()">上传</button>
                                    </div>
                                </form>
<%--                                <form id="upGoods">--%>
